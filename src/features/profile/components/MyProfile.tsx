...
export default function AccountProfile() {
  ...
  console.log('User data in MyProfile:', user); // Debugging log
  ...
  const {
    ...
    defaultValues: {
      ...
      terms: true, // already agreed at signup
  ...
  const onSubmit = (data: FormValues) => {
    ...
    updateProfileMutation.mutate(updateData, {
      onSuccess: () => {
        reset({
          ...data,
          image: updateData.image ?? data.image
        }) 
            ...
            <Controller
              ...
              render={({ field }) => (
                <IDUploadField
                  ...
                  isEditing={isEditing}
                  initialPreview={user?.IDFront ?? null}  // the URL string from your user state
                />
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <IDUploadField
                  ...
                  isEditing={isEditing}
                  initialPreview={user?.IDBack ?? null}  // the URL string from your user state
                />
              )}
            />
          </div>
