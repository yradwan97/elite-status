...
export function LoginForm({ setMode, onClose }: { setMode: Dispatch<SetStateAction<AuthMode>>; onClose: () => void }) {
  ...
  return (
    ...
    <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div onClick={() => setMode("forget")} className="text-right text-navy font-semibold cursor-pointer" style={{ fontSize: "1rem" }}>
